<template>
    <span>
        ...
        >
            <div class="yum-popover"
                 :class="'yum-popover-'+direction"
                 :style="{width, top: top + 'px', left: left + 'px'}"
                 ref="popover"
                 v-show="!disabled && showPopover"
            >
                <div class="yum-popover__title" v-text="title"></div>
                <slot>{{ content }}</slot>
                <div ref="arrow" class="yum__arrow"
                     :class="'yum-arrow-'+direction"
...
<style scoped>
    ...
    .yum-arrow-left, .yum-arrow-right {
        top: 50%;
        margin-top: -3px;
    }
